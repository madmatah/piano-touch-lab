...
import { CurveSmootherMedian } from './curve-smoother-median';
import type { DataPointsExtractorRequirements } from './data-points-extractor/data-points-extractor-requirements';

describe('The CurveSmootherMedian class', () => {
  let curveSmoother: CurveSmootherMedian;
  ...
  beforeEach(() => {
    ...
    curveSmoother = new CurveSmootherMedian(mockDataPointsExtractor);
  });
  ...
  describe('The smoothCurve() method', () => {
    ...
    describe('When valid data points exist', () => {
      ...
      it('should return median value for all positions', () => {
        expect(result).toEqual([2.5, 2.5, 2.5, 2.5, 2.5]);
      });
    ...
    describe('When there are three data points', () => {
      ...
      it('should return the middle value for all positions', () => {
    ...
    describe('When data contains decimal numbers', () => {
      ...
      it('should calculate median correctly', () => {
        expect(result).toEqual([2.7, 2.7, 2.7, 2.7]);
      });
    });
    ...
    describe('When data points are unsorted', () => {
      ...
      it('should sort and calculate median correctly', () => {
        expect(result).toEqual([20, 20, 20, 20]);
      });
    });
